...
def add_mouse_buttons(
    ...
    for button in unique_buttons:
        ...
        for k, event in enumerate(data):
            ...
            # durations is set to 0 for wheel motions, which do not have a released
            # event
