...
def create_epochs_evoked_and_behavioral_metadata(
    ...
    *,
    ...
    derivatives = [
        ...
        derivatives_folder
        / "plots"
        / f"{fname_stem}_step60b-1-originalmast_stimlocked-epochs-rejected.svg",
        derivatives_folder
        / f"{fname_stem}_step60b-1-originalmast_stimlocked-cleaned-epo-drop-log.csv",
        derivatives_folder
        / f"{fname_stem}_step60b-1_stimlocked_originalmast-standard-ave.fif",
        derivatives_folder
        / f"{fname_stem}_step60b-1_stimlocked_originalmast-target-ave.fif",
        derivatives_folder
        / f"{fname_stem}_step60b-1_stimlocked_originalmast-novel-ave.fif",
...
#####,
 ...
 """
        epochs.save(
            derivatives_folder
            / f"{fname_stem}_step60b-1_stimlocked_originalmast-epo.fif",
        )

        for cond in epochs.event_id:
            evokeds[cond].save(
                derivatives_folder
                / f"{fname_stem}_step60b-1_stimlocked_originalmast-{cond}-ave.fif"
            )
