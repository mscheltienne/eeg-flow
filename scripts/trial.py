...
# Create sounds
sound_standard = Sound('snd/low_tone-48000.wav', blockSize=32,
                       preBuffer=-1, hamming=True)
sound_target = Sound('snd/high_tone-48000.wav', blockSize=32,
                     preBuffer=-1, hamming=True)
...
for trial in trials:
    if trial in ('standard', 'target'):
        continue
    sounds[trial] = Sound(f'snd/{trial}-48000.wav', blockSize=32,
                          preBuffer=-1, hamming=True)
